...
class NimAI():
    ...
    def get_q_value(self, state, action):
        ...
        """
        q_value = 0
        tupla = (tuple(state),action)
        if tupla in self.q:
            q_value = self.q[tupla]
        return q_value
    ...
    def update_q_value(self, state, action, old_q, reward, future_rewards):
        ...
        """
        tupla = (tuple(state),action)
        self.q[tupla] = old_q + self.alpha * (reward + future_rewards - old_q)
    ...
    def choose_action(self, state, epsilon=True):
        ...
        if epsilon:
            ...
            if random.random() <= self.epsilon:
                ...
                action = self.choose_best_action(state, available_actions)
